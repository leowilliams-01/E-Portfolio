...
<div style="max-width: 900px; margin: 0 auto; padding: 2rem 2rem 2rem 2rem;">
  ...
  <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.5rem; margin-bottom: 4rem;">
    ...
    <a href="mangrovemapping.html" class="project-card-hover" style="background: #ffffff; border: 1px solid #e0e0e0; border-radius: 2px; overflow: hidden; text-decoration: none; display: block; border-bottom: none;">
    ...
    <a href="lidarmetrics.html" class="project-card-hover" style="background: #ffffff; border: 1px solid #e0e0e0; border-radius: 2px; overflow: hidden; text-decoration: none; display: block; border-bottom: none;">
    ...
    <a href="lidr_boulders.html" class="project-card-hover" style="background: #ffffff; border: 1px solid #e0e0e0; border-radius: 2px; overflow: hidden; text-decoration: none; display: block; border-bottom: none;">
...
<a href="salmon_stream.html" class="project-card-hover" style="background: #ffffff; border: 1px solid #e0e0e0; border-radius: 2px; overflow: hidden; text-decoration: none; display: block; border-bottom: none;">
  <img src="images/cohosalmonmap.jpg" style="width: 100%; aspect-ratio: 16/9; object-fit: cover; margin: 0; border-radius: 0; box-shadow: none;"/>
  <div style="padding: 1rem 1.25rem 1.25rem;">
    <div style="font-size: 0.72rem; font-weight: 500; letter-spacing: 0.1em; text-transform: uppercase; color: #2d5a4e; margin-bottom: 0.3rem;">ArcGIS Pro · Network Analysis · Hydrology</div>
    <div style="font-size: 0.95rem; font-weight: 500; color: #1a1a1a; margin-bottom: 0.4rem;">Salmon Stream Network Analysis</div>
    <p style="font-size: 0.83rem; color: #777777; line-height: 1.6; margin: 0;">Modelling accessible salmon spawning habitat on Vancouver Island using DEM-derived stream networks and dam barriers.</p>
  </div>
</a>
  </div>
</div>
